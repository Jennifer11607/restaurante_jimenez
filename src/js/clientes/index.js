...
const getClientes = async (alerta='si') => {
    ...
    const url = `/restaurante_jimenez/controladores/clientes/index.php?cli_nombre=${nombre}&cli_apellido=${apellido}&cli_telefono=${telefono}`
    const config = {
        method: 'GET'
    }
console.log(url)
...
const guardarCliente = async (e) => {
    ...
    const url = '/restaurante_jimenez/controladores/clientes/index.php';
