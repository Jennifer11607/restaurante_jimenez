...
class Cliente extends Conexion
{
    ...
    {
        $sql = "INSERT INTO clientes(cli_nombre, cli_apellido, cli_telefono) values('$this->cli_nombre','$this->cli_apellido','$this->cli_telefono')";
    ...
    {
        $sql = "UPDATE clientes SET cli_nombre = '$this->cli_nombre', cli_apellido = '$this->cli_apellido', cli_telefono = '$this->cli_telefono' where cli_id = $this->cli_id";
