            ...
            <table class="table table-bordered" style="font-family:'Courier New', Courier, monospace; background-color: darkgoldenrod;">
                <thead>
                    <tr class="text-center table-primary table-bordered rounded border border-primary">
                        <th colspan="9">DETALLE DE LA RESERVACION</th>
                    </tr>
                </thead>
                ...
                <tr>
                    ...
                    <th>FECHA</th>
                    <th>CANTIDAD DE MESA</th>
                    <th>CUANTAS PERSONAS</th>
                    <th>UBICACION DE LA MESA</th>
                </tr>
                <?php if(count($busqueda) > 0) { ?>
                    <?php foreach ($busqueda as $key => $opciones) : ?>
                        <tr>
                            ...
                            <td><?= $opciones['RESER_FECHA'] ?></td>
                            <td><?= $opciones['MESA_NUMERO'] ?></td>
                            <td><?= $opciones['MESA_CAPACIDAD'] ?></td>
                            <td><?= $opciones['MESA_UBICACION'] ?></td>
